...
/**
 * Created by Lucare.Feng on 2016/8/9.
 * 中文姓名转化为首字母大写
 */
public class NameCodeUtil {
    ...
    public char StringAlpha(String SourceStr) {
        char result = 'A';
        try {
    ...
    public static void main(String[] args) {
        NameCodeUtil obj1 = new NameCodeUtil();
        System.out.println(obj1.StringAlpha("长胜"));
    }

    public static String getCode(String name){
        NameCodeUtil cu = new NameCodeUtil();
        char a = ' ';
        if(!Strings.isEmpty(name)){
            a = cu.StringAlpha(name);
        }
